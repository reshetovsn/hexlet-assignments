...
class ValidationTest {
    ...
    void testadvancedValidate() {
        Address address1 = new Address("Russia", "Moscow", "Lenina", "54", null);
        Map<String, List<String>> result1 = Validator.advancedValidate(address1);
        Map<String, List<String>> expected1 = Map.of();
        assertThat(result1).isEqualTo(expected1);

        Address address2 = new Address(null, "Ufa", "1-st street", "5", "1");
        ...
        Map<String, List<String>> expected2 = Map.of("country", List.of("can not be null", "length less than 5"),
                "city", List.of("length less than 4"));
        assertThat(result2).isEqualTo(expected2);

        Address address3 = new Address("USA", null, null, null, "1");
        Map<String, List<String>> result3 = Validator.advancedValidate(address3);
        Map<String, List<String>> expected3 = Map.of("country", List.of("length less than 5"),
                "city", List.of("can not be null", "length less than 4"),
